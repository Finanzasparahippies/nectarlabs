 ...
 */
const broadcastToRoom = (chatId, data) => {
        ...
        try {
            ...
            switch (data.type) {
                ...
                case 'message': {
                    ...
                    const insertRes = await pool.query(`INSERT INTO tickets_supportchatmessage (chat_id, sender_id, message, is_ai_message, created_at)
             VALUES ($1, $2, $3, false, NOW())
             RETURNING id, chat_id, sender_id, message, is_ai_message, created_at`, [chatId, clientConn.userId, text]);
                    ...
                    if (chat.status === 'OPEN' && !isAgent) {
                        ...
                        await generateAiReplyStream(chatId, text, 
                        ...
                        async (fullText) => {
                            try {
                                const aiInsertRes = await pool.query(`INSERT INTO tickets_supportchatmessage (chat_id, sender_id, message, is_ai_message, created_at)
                     VALUES ($1, $2, $3, true, NOW())
                     RETURNING id, chat_id, sender_id, message, is_ai_message, created_at`, [chatId, chat.client_id, fullText]);
