...
- Name: cursos.spec.ts >> Curso de Python - Dashboard Interactivo (Enfoque A) >> Debe permitir la navegación fluida entre pestañas (Teoría, Ejemplos, Ejercicios)
- Location: tests/cursos.spec.ts:41:7
