...
- Name: cursos.spec.ts >> Curso de Python - Dashboard Interactivo (Enfoque A) >> Debe evaluar offline mostrando feedback de keywords si no está autenticado
- Location: tests/cursos.spec.ts:54:7
