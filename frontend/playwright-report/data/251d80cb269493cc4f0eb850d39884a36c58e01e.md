...
- Name: cursos.spec.ts >> Curso de Python - Dashboard Interactivo (Enfoque A) >> Debe cargar el curso con título,Badge y los Módulos de la barra lateral
- Location: tests/cursos.spec.ts:12:7
...
Locator: locator('#current-module-title')
Expected substring: "Python Avanzado y Edge Cases"
Received string:    "Fundamentos Avanzados"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('#current-module-title')
    14 × locator resolved to <h1 id="current-module-title">Fundamentos Avanzados</h1>
       - unexpected value "Fundamentos Avanzados"

```

```yaml
- heading "Fundamentos Avanzados" [level=1]
```
