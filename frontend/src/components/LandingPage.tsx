    ...
    <LandingDataProvider>
      <div className="min-h-screen flex flex-col items-center selection:bg-nectar-gold selection:text-nectar-cream">
        ...
        <section className="w-full relative overflow-hidden pt-32 sm:pt-48 pb-20 sm:pb-32 px-6 flex flex-col items-center text-center">
          ...
          <div className="inline-block px-6 py-2.5 sm:px-10 sm:py-3 mb-10 sm:mb-12 text-2xs sm:text-sm font-black tracking-[0.3em] sm:tracking-[0.5em] text-nectar-gold uppercase border-2 border-nectar-gold/20 rounded-full bg-white/50 dark:bg-nectar-forest/50 glass animate-premium">
          ...
          <div className="w-full max-w-7xl text-center">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-8 gap-x-6 gap-y-10 items-center justify-items-center">
              ...
              <div className="flex flex-col items-center gap-2.5 group transition-transform duration-300 hover:scale-110 cursor-pointer">
                ...
                <span className="text-2xs font-black tracking-widest uppercase opacity-60 group-hover:opacity-100 group-hover:text-emerald-400 transition-all font-mono">Django 5</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2.5 group transition-transform duration-300 hover:scale-110 cursor-pointer">
                ...
                <span className="text-2xs font-black tracking-widest uppercase opacity-60 group-hover:opacity-100 group-hover:text-blue-400 transition-all font-mono">Python 3.12</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2.5 group transition-transform duration-300 hover:scale-110 cursor-pointer">
                ...
                <span className="text-2xs font-black tracking-widest uppercase opacity-60 group-hover:opacity-100 group-hover:text-white transition-all font-mono">Next.js 16</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2.5 group transition-transform duration-300 hover:scale-110 cursor-pointer">
                ...
                <span className="text-2xs font-black tracking-widest uppercase opacity-60 group-hover:opacity-100 group-hover:text-cyan-400 transition-all font-mono">React 19</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2.5 group transition-transform duration-300 hover:scale-110 cursor-pointer">
                <div className="w-14 h-14 rounded-2xl bg-[#3178C6]/20 border border-[#3178C6]/40 flex items-center justify-center shadow-lg group-hover:border-[#3178C6] group-hover:bg-[#3178C6]/40 group-hover:shadow-blue-500/20 transition-all">
                  <div className="w-7 h-7 rounded bg-[#3178C6] text-white flex items-end justify-end p-0.5 font-black text-2xs leading-none font-mono">
                    TS
                  </div>
                </div>
                <span className="text-2xs font-black tracking-widest uppercase opacity-60 group-hover:opacity-100 group-hover:text-[#3178C6] transition-all font-mono">TypeScript</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2.5 group transition-transform duration-300 hover:scale-110 cursor-pointer">
                <div className="w-14 h-14 rounded-2xl bg-yellow-950/30 border border-yellow-500/30 flex items-center justify-center shadow-lg group-hover:border-yellow-400 group-hover:bg-yellow-950/60 group-hover:shadow-yellow-500/20 transition-all">
                  <div className="w-7 h-7 rounded bg-yellow-400 text-black flex items-end justify-end p-0.5 font-black text-2xs leading-none font-mono">
                    JS
                  </div>
                </div>
                <span className="text-2xs font-black tracking-widest uppercase opacity-60 group-hover:opacity-100 group-hover:text-yellow-400 transition-all font-mono">JavaScript</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2.5 group transition-transform duration-300 hover:scale-110 cursor-pointer">
                ...
                <span className="text-2xs font-black tracking-widest uppercase opacity-60 group-hover:opacity-100 group-hover:text-emerald-400 transition-all font-mono">Node.js 20</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2.5 group transition-transform duration-300 hover:scale-110 cursor-pointer">
                ...
                <span className="text-2xs font-black tracking-widest uppercase opacity-60 group-hover:opacity-100 group-hover:text-emerald-400 transition-all font-mono">Supabase</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2.5 group transition-transform duration-300 hover:scale-110 cursor-pointer">
                ...
                <span className="text-2xs font-black tracking-widest uppercase opacity-60 group-hover:opacity-100 group-hover:text-sky-400 transition-all font-mono">Docker</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2.5 group transition-transform duration-300 hover:scale-110 cursor-pointer">
                ...
                <span className="text-2xs font-black tracking-widest uppercase opacity-60 group-hover:opacity-100 group-hover:text-blue-400 transition-all font-mono">PostgreSQL</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2.5 group transition-transform duration-300 hover:scale-110 cursor-pointer">
                ...
                <span className="text-2xs font-black tracking-widest uppercase opacity-60 group-hover:opacity-100 group-hover:text-cyan-400 transition-all font-mono">Tailwind</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2.5 group transition-transform duration-300 hover:scale-110 cursor-pointer">
                ...
                <span className="text-2xs font-black tracking-widest uppercase opacity-60 group-hover:opacity-100 group-hover:text-amber-400 transition-all font-mono">Tauri v2</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2.5 group transition-transform duration-300 hover:scale-110 cursor-pointer">
                ...
                <span className="text-2xs font-black tracking-widest uppercase opacity-60 group-hover:opacity-100 group-hover:text-white transition-all font-mono">GitHub</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2.5 group transition-transform duration-300 hover:scale-110 cursor-pointer">
                ...
                <span className="text-2xs font-black tracking-widest uppercase opacity-60 group-hover:opacity-100 group-hover:text-rose-400 transition-all font-mono">Redis</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2.5 group transition-transform duration-300 hover:scale-110 cursor-pointer">
                ...
                <span className="text-2xs font-black tracking-widest uppercase opacity-60 group-hover:opacity-100 group-hover:text-indigo-400 transition-all font-mono">Stripe</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2.5 group transition-transform duration-300 hover:scale-110 cursor-pointer">
                ...
                <span className="text-2xs font-black tracking-widest uppercase opacity-60 group-hover:opacity-100 group-hover:text-red-400 transition-all font-mono">Hetzner Cloud</span>
              </div>
            </div>
          </div>
        </section>
