...
export default function ErrorBoundary({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error('Néctar Labs Tenant Runtime Error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#020403] text-foreground p-6 text-center">
      <div className="relative max-w-md p-8 rounded-[2.5rem] bg-[#0d1511]/60 border border-emerald-500/10 backdrop-blur-xl">
        ...
        <h2 className="text-lg font-black uppercase tracking-widest text-white mb-2">Desarmonía en el Sistema</h2>
        <p className="text-xs text-white/60 mb-6 leading-relaxed">
          Ha ocurrido una discrepancia inesperada en este portal de aprendizaje. Contempla la calma y refresca el flujo.
        </p>
